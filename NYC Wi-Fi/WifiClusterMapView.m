...
@interface WifiClusterMapView (Private)
- (void) setup;
- (BOOL) mapViewDidZoom;
@end

@implementation WifiClusterMapView
...
- (void) addAnnotations:(NSArray *)annotations
{
    ...
    NSArray *add = [WifiClusterManager clusterAnnotationsForMapView:self forAnnotations:annotations blocks:self.blocks minClusterLevel:self.minimumClusterLevel];
